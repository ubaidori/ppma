...
<head>
  ...
  <title>Home - Pondok Pesantren Mathali'ul Anwar</title>
...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative">
      ...
      <div class="top-row d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-end">
          ...
          <h1 class="sitename">mathaliulanwar</h1><span>.net</span>
        </a>

        <div class="d-flex align-items-center">
          <div class="social-links">
            {{-- <a href="https://wa.me/6281336857778" class="whatsapp"><i class="bi bi-whatsapp"></i></a> --}}
            <a href="https://www.instagram.com/mathaliul.anwar/" class="instagram"><i class="bi bi-instagram"></i></a>
            {{-- <a href="https://www.facebook.com/p.p.mathaliulanwar" class="facebook"><i class="bi bi-facebook"></i></a> --}}
            <a href="https://www.youtube.com/channel/UCq2G-ijAAA7ANcpaxayqp7A" class="youtube"><i class="bi bi-youtube"></i></a>
          </div>
      ...
      <div class="container d-flex justify-content-center position-relative">
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="{{ route('category') }}">Berita</a></li>
            <li><a href="{{ route('category') }}">Mading</a></li>
            <li><a href="{{ route('about') }}">Monitoring</a></li>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="blog-grid">
          ...
          <article class="blog-item featured" data-aos="fade-up">
            <img src="{{ asset('assets/img/blog/blog-post-3.webp') }}" alt="Blog Image" class="img-fluid">
          ...
          <article class="blog-item" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ asset('assets/img/blog/blog-post-portrait-1.webp') }}" alt="Blog Image" class="img-fluid">
            <div class="blog-content">
              <div class="post-meta">
                <span class="date">Apr. 14th, 2025</span>
          ...
          <article class="blog-item" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets/img/blog/blog-post-9.webp') }}" alt="Blog Image" class="img-fluid">
            <div class="blog-content">
              <div class="post-meta">
                <span class="date">Apr. 14th, 2025</span>
          ...
          <article class="blog-item" data-aos="fade-up" data-aos-delay="300">
            <img src="{{ asset('assets/img/blog/blog-post-7.webp') }}" alt="Blog Image" class="img-fluid">
            <div class="blog-content">
              <div class="post-meta">
                <span class="date">Apr. 14th, 2025</span>
          ...
          <article class="blog-item" data-aos="fade-up" data-aos-delay="400">
            <img src="{{ asset('assets/img/blog/blog-post-6.webp') }}" alt="Blog Image" class="img-fluid">
            <div class="blog-content">
              <div class="post-meta">
                <span class="date">Apr. 14th, 2025</span>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="{{ asset('assets/img/blog/blog-post-portrait-1.webp') }}" alt="Blog Image">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="{{ asset('assets/img/blog/blog-post-portrait-2.webp') }}" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="{{ asset('assets/img/blog/blog-post-portrait-3.webp') }}" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="{{ asset('assets/img/blog/blog-post-portrait-4.webp') }}" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="{{ asset('assets/img/blog/blog-post-portrait-5.webp') }}" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 mb-4">
          <div class="col-lg-4">
            <article class="featured-post">
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-6.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Health</span>
                  <div class="author-meta">
                    <img src="{{ asset('assets/img/person/person-f-13.webp') }}" alt="" class="author-img">
          ...
          <div class="col-lg-4">
            <article class="featured-post">
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-7.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
          ...
          <div class="col-lg-4">
            <article class="featured-post">
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-5.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
                  <div class="author-meta">
                    <img src="{{ asset('assets/img/person/person-f-14.webp') }}" alt="" class="author-img">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-9.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-10.webp') }}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
          ...
          <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
            <img src="{{ asset('assets/img/misc/misc-1.webp') }}" alt="Digital Platform" class="img-fluid rounded-4">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-4.webp') }}" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="{{ asset('assets/img/person/person-f-14.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-5.webp') }}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="{{ asset('assets/img/blog/blog-post-6.webp') }}" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="{{ asset('assets/img/person/person-f-15.webp') }}" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">Mathali'ul Anwar</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Jl. Kartini VI/09 Desa Pangarangan Kec. KotaSumenep </p>
            <p>Kab Sumenep, Jawa Timur 69412</p>
            <p class="mt-3"><strong>Phone:</strong> <span>0813 3685 7778</span></p>
            <p><strong>Email:</strong> <span>mathaliulanwar1@gmail.com</span></p>
          </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename"> Pondok Pesantren Mathali'ul Anwar</strong></p>
      <div class="credits">
